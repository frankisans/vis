...
Group.prototype.setData = function (data) {
    ...
    if (sideContent instanceof Element) {
        ...
        this.dom.sideInner.appendChild(sideContent);
    } else if (sideContent instanceof Object && content.isReactComponent) {
        // Do nothing. Component was rendered into the node be ReactDOM.render.
        // That branch is necessary for evasion of a second call templateFunction.
        // Supports only React < 16(due to the asynchronous nature of React 16).
...
Group.prototype._didResize = function (resized, height) {
    ...
    var boundingRectSide = this.dom.sideInner.getBoundingClientRect();
    var labelWidthSide = boundingRectSide.width;
    var labelHeightSide = boundingRectSide.height;
    resized = util.updateProperty(this.props.sideLabel, 'width', labelWidthSide) || resized;
    resized = util.updateProperty(this.props.sideLabel, 'height', labelHeightSide) || resized;
    return resized;
}
